...
1. If the vault operating manual (`_CLAUDE.md`) is not already in your context, read it from the vault root, to find the boards folder and kanban convention (columns, priority markers, `@{date}` format).
